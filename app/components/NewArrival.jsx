...
export const NewArrival = ({ newArrivals }) => {
  const title = newArrivals?.title?.value;

  const products = [
    newArrivals?.product1?.reference,
    newArrivals?.product2?.reference,
    newArrivals?.product3?.reference,
    newArrivals?.product4?.reference,
  ].filter(Boolean);
